...
) ENGINE=InnoDB AUTO_INCREMENT=2253 DEFAULT CHARSET=gbk;
...
CREATE TABLE `m_resource` (
  ...
  `resource_uri` varchar(255) COLLATE utf8_bin DEFAULT NULL,
...
INSERT INTO `m_resource` VALUES (1,'/deleteUser','deleteUser','deleteUser');
...
INSERT INTO `m_role` VALUES (1,'admin'),(2,'manager'),(3,'staff');
/*!40000 ALTER TABLE `m_role` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `m_role_resource`
--
...
--
-- Dumping data for table `m_role_resource`
--

LOCK TABLES `m_role_resource` WRITE;
/*!40000 ALTER TABLE `m_role_resource` DISABLE KEYS */;
INSERT INTO `m_role_resource` VALUES (1,1,1);
/*!40000 ALTER TABLE `m_role_resource` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `m_user` VALUES (1,'admin','c649d6185032697ada52a13e7ea75bf3','2020-01-11 14:34:26'),(2,'manager','51c017d79ab2eea8548f22543409cd05','2020-01-11 14:40:18'),(3,'staff','51c017d79ab2eea8548f22543409cd05','2020-01-11 14:40:29');
...
INSERT INTO `m_user_role` VALUES (1,1,1),(2,2,2),(3,3,3);
...
-- Dump completed on 2020-01-11 14:57:15
